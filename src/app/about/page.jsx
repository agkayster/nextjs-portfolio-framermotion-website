				...
				<div className='p-4 sm:p-8 md:p-12 lg:p-20 xl:p-48 flex flex-col gap-24 md:gap-32 lg:gap-48 xl:gap-64'>
					...
					<div className='flex flex-col gap-12 justify-center'>
						...
						<p className='text-lg'>
							...
							elit. Exercitationem illum adipisci cum suscipit
							quisquam. Enim nihil sapiente eligendi quo repellat
							eius animi a ad ut id. Corporis consequuntur
							temporibus architecto! Lorem ipsum dolor sit amet
							consectetur adipisicing elit. Minus minima optio
							corporis totam voluptatum, nemo adipisci, architecto
							numquam sint ratione fugiat repellat incidunt quidem
							odio. Quisquam optio perspiciatis ex voluptatum.
						</p>
						{/* BIOGRAPHY QUOTE */}
